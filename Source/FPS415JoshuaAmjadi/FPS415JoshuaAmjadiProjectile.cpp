...
AFPS415JoshuaAmjadiProjectile::AFPS415JoshuaAmjadiProjectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AFPS415JoshuaAmjadiProjectile::OnHit);		// set up a notification for when this component hits something blocking
