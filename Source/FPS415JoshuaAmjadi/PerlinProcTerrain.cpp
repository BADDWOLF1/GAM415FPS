...
#include "../../../../../../Program Files/Epic Games/UE_5.4/Engine/Plugins/Runtime/ProceduralMeshComponent/Source/ProceduralMeshComponent/Public/KismetProceduralMeshLibrary.h"
...
void APerlinProcTerrain::AlterMesh(FVector impactPoint)
{
	for (int i = 0; i < Vertices.Num(); i++)
	{
		...
		if (FVector(Vertices[i] - tempVector).Size() < radius)
		{
			...
			ProcMesh->UpdateMeshSection(sectionID, Vertices, UV0, UpVertexColors, TArray<FProcMeshTangent>());
		}
	}
}
